...
const models = [
  ...
  { ramMin: 32, vramMin: 24, models: [{"Mistral Small 3.2": { parameters: 24, quantization: 'Q6_K_XL' }}], usefulness: 0.7},
  { ramMin: 32, vramMin: 16, models: [{"Mistral Small 3.2": { parameters: 30, quantization: 'Q4_K_XL' }}], usefulness: 0.6},
